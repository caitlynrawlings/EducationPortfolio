      ...
      <div className="section" id="meetings">
        ...
        <div style={{ marginBottom: '2rem' }}>
          <h3>PLC Meetings</h3>
            ...
            <div className="artifact-block">
              <div className="artifact-meta">PLC Meeting · March 13, 2026</div>
              <strong>Agenda:</strong>
              <ul>
              ...
              <p><strong>Falcon Times Planning</strong></p>
              <ul>
                <li>P. — Test</li>
                <li>E. — Test</li>
                <li>J. — Test</li>
                <li>Mentor Teacher — Circle</li>
                <li>J. — Test</li>
              </ul>

              <br />

              <p><strong>Upcoming Team Observations</strong></p>
              <p>
                The team was asked to select a Standard of Mathematical Practice related 
                to student talk and discourse. Focus standard: <em>CCSS.Math.Practice.MP3 — 
                Construct viable arguments and critique the reasoning of others.</em>
              </p>
              <p><em>Teacher Look-Fors:</em></p>
              <ul>
                <li>Wait time and silent think time</li>
                <li>Sentence starters</li>
                <li>Acknowledging all points of view</li>
                <li>Asking open-ended and DOK questions</li>
                <li>Finding ways to engage all students</li>
              </ul>
              <p><em>Student Look-Fors:</em></p>
              <ul>
                <li>Constructing viable arguments</li>
                <li>Critiquing each other's reasoning respectfully</li>
                <li>Quality responses beyond simply disagreeing</li>
                <li>Comfort making mistakes and sharing reasoning</li>
                <li>Engagement</li>
              </ul>

              <br />

              <p><strong>End-of-Unit Survey</strong></p>
              <p>Team reviewed and discussed the end-of-unit survey.</p>

              <br />

              <p><strong>Assessment & Curriculum Discussion</strong></p>
              <ul>
                <li>Discussed adjusting tests to group standards together</li>
                <li>Team to create exemplars for upcoming units across 6th, 7th, and 8th grade</li>
              </ul>
              ...
              <p><em>6th Grade</em></p>
              <ul>
                <li>This week: Cool Down 6.6.14</li>
              </ul>
              <p><em>7th Grade</em></p>
              <ul>
                <li>This week: 7.6 End-of-Unit Assessment</li>
              </ul>
              <p><em>8th Grade</em></p>
              <ul>
                <li>This week: Lesson 3 Cooldown (square roots)</li>
              </ul>

              <div className="callout">
                <span className="label">My Contributions and Reflections</span>
                I helped contribute by assigning kids to my Mentor Teacher's classes for the next Falcon Time, where 
